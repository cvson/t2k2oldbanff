...
pfile_stat_inv[isam] = new TFile(Form("../plots/pac7d8e21_dcp_point1_optv2s13off_dcp%d_inv_wreactorthrow_StatOnly.root",isam+1));
    ...
    TString subname = "t2kpre_dcp_point1_100k4check_100ksensi_wreactorthrow_optv2s13off_truedcp_unknownMH_fakesyst";
    //make graph
...
gr68->Draw("Lsame");
    gr90->Draw("Lsame");
    gr95->Draw("Lsame");
TLegend* leg0 = new TLegend(.17, .69, 0.85, .90);
leg0->SetMargin(0.1);
    leg0->SetFillStyle(0);
...
leg0->AddEntry(s330,"20x10^{21} POT w/ eff. stat. & sys. improvements","l");
