...
TFile *pfile_stat_inv[NSAMPLE];
    ...
    pfile30_inv[isam] = new TFile(Form("../../PACdcpsyst/plots/pac30e21_dcp_point1_100k4check_optv2s13off_100ksensi_dcp%d_inv_wreactorthrow.root",isam+1));
...
pfile_stat_inv[isam] = new TFile(Form("../../PACdcpsyst/plots/pac30e21_dcp_point1_100k4check_optv2s13off_sin23hi_100ksensi_dcp%d_inv_wreactorthrow.root",isam+1));
    hisdcp_stat_inv[isam] = (TH1D*) pfile_stat_inv[isam]->Get("SA_dcp");
    
    pfile30_stat_inv[isam] = new TFile(Form("../../PACdcpsyst/plots/pac30e21_dcp_point1_100k4check_optv2s13off_sin23lo_100ksensi_dcp%d_inv_wreactorthrow.root",isam+1));
    hisdcp30_stat_inv[isam] = (TH1D*) pfile30_stat_inv[isam]->Get("SA_dcp");

 }
    
    TString subname = "t2kpre_dcp_point1_100k4check_100ksensi_wreactorthrow_optv2s13off_truedcp_unknownMH_fakesyst_lohi";
    //make graph
