{
    ...
    TString subname = "t2kpre_dcp_point1_100k_wreactorthrow_all_optv2s13off_statvssyst_lohi_ver2";
...
leg0->Draw();
 ...
 ci = TColor::GetColor("#000000");
    ...
    leg1->SetTextSize(18);
    leg1->SetTextFont(43);
leg1->AddEntry(s3,"w/ eff. stat. improvements (no sys. errs.)","l");
leg1->AddEntry(s3syst,"w/ 2016 sys. errs.","l");
leg1->Draw();
