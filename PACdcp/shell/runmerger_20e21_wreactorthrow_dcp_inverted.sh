...
#OD=pac20e21_narrow2_wreactorthrow_inverted_merger_${ODN}
#OD=pac20e21_100k4check_optv2s13off_sin23hi_inv_wreactorthrow_merger_${ODN}
OD=pac20e21_100k4check_optv2s13off_sin23lo_inv_wreactorthrow_merger_${ODN}
