...
#OD=pac6e21_narrow4_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac6e21_narrow2x_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac6e21_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac6e21_opt_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac6e21_optv2s13off_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac6e21_optv2s13off_sin23hi_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac6e21_optv2s13off_sin23lo_nohioct_wreactorthrow_StatOnly_merger_${ODN}
OD=pac6e21_optv2s13off_sin23hi_nolooct_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac6e21_optv2s13off_sin23lod4_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac6e21_optv2s13off_sin23lo_101bin_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac6e21_optv2s13off_sin23lo_christprior_wreactorthrow_StatOnly_merger_${ODN}
...
./Merger \
-t ${DIR}/outputs/Template_files/Templates_pac6e21_StatOnly.root \
