...
#OD=pac7d8e21c4_narrow4_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac7d8e21c4_narrow2x_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac7d8e21c4_wreactorthrow_StatOnly_merger_${ODN}
OD=pac7d8e21c4_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac7d8e21c4_optv2s13off_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac7d8e21c4_optv2s13off_sin23hi_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac7d8e21c4_optv2s13off_sin23lo_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac7d8e21c4_optv2s13off_sin23lo_nohioct_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac7d8e21c4_optv2s13off_sin23lod4_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac7d8e21c4_optv2s13off_sin23lo_101bin_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac7d8e21c4_optv2s13off_sin23lo_christprior_wreactorthrow_StatOnly_merger_${ODN}
...
./Merger \
-t ${DIR}/outputs/Template_files/statonly/Templates_pac7d8e21c4_StatOnly.root \
