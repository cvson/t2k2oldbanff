...
#OD=current_narrow4_wreactorthrow_StatOnly_merger_${ODN}
#OD=current_narrow2x_wreactorthrow_StatOnly_merger_${ODN}
#OD=current_opt_wreactorthrow_StatOnly_merger_${ODN}
OD=current_s13off_wreactorthrow_StatOnly_merger_${ODN}
#OD=current_wreactorthrow_StatOnly_merger_${ODN}
