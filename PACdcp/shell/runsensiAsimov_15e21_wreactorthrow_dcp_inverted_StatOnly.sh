...
ID=pac15e21_wreactorthrow_inverted_StatOnly_merger_${ODN}
OD=pac15e21_wreactorthrow_inverted_StatOnly_sensiAsimov_${ODN}
...
-e ${DIR}/outputs/AsimovPoint01_PAC_15e21_Xp_StatOnly.root \
-b ${inum} \
