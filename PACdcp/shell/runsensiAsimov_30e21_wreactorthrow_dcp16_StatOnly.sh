...
#OD=pac30e21_optv2s13off_dcp16_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#ID=pac30e21_optv2s13off_sin23hi_wreactorthrow_StatOnly_merger_${IDN}
#OD=pac30e21_optv2s13off_sin23hi_dcp16_wreactorthrow_StatOnly_sensiAsimov_${ODN}
ID=pac30e21_optv2s13off_sin23lo_wreactorthrow_StatOnly_merger_${IDN}
OD=pac30e21_optv2s13off_sin23lo_dcp16_wreactorthrow_StatOnly_sensiAsimov_${ODN}
