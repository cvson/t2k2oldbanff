...
#OD=pac30e21_optv2s13off_dcp25_inv_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#ID=pac30e21_optv2s13off_sin23hi_inv_wreactorthrow_StatOnly_merger_${IDN}
#OD=pac30e21_optv2s13off_sin23hi_dcp25_inv_wreactorthrow_StatOnly_sensiAsimov_${ODN}
ID=pac30e21_optv2s13off_sin23lo_inv_wreactorthrow_StatOnly_merger_${IDN}
OD=pac30e21_optv2s13off_sin23lo_dcp25_inv_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#ID=pac30e21_narrow2x_wreactorthrow_StatOnly_merger_${IDN}
