...
#ID=pac30e21_100k4check_optv2s13off_inv_wreactorthrow_merger_${IDN}
#OD=pac30e21_100k4check_optv2s13off_dcp30_inv_wreactorthrow_sensiAsimov_${ODN}
#ID=pac30e21_100k4check_optv2s13off_sin23hi_inv_wreactorthrow_merger_${IDN}
#OD=pac30e21_100k4check_optv2s13off_sin23hi_dcp30_inv_wreactorthrow_sensiAsimov_${ODN}
ID=pac30e21_100k4check_optv2s13off_sin23lo_inv_wreactorthrow_merger_${IDN}
