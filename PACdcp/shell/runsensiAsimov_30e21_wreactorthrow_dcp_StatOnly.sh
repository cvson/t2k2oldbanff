...
#OD=pac30e21_sin23lo04_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=pac30e21_sin23lo_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=pac30e21_sin23lo047_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=pac30e21_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#ID=pac30e21_optv2s13off_sin23lo_nohioct_wreactorthrow_StatOnly_merger_${IDN}
#OD=pac30e21_optv2s13off_sin23lo_nohioct_wreactorthrow_StatOnly_sensiAsimov_${ODN}
ID=pac30e21_optv2s13off_sin23hi_nolooct_wreactorthrow_StatOnly_merger_${IDN}
OD=pac30e21_optv2s13off_sin23hi_nolooct_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=pac30e21_sin23hi528_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=pac30e21_sin23hi57_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=pac30e21_sin23hi_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#ID=pac30e21_optv2s13off_wreactorthrow_StatOnly_merger_${IDN}
#OD=pac30e21_optv2s13off_dcp1_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#ID=pac30e21_optv2s13off_sin23lo_wreactorthrow_StatOnly_merger_${IDN}
#OD=pac30e21_optv2s13off_sin23lo_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#ID=pac30e21_optv2s13off_sin23lod4_wreactorthrow_StatOnly_merger_${IDN}
#OD=pac30e21_optv2s13off_sin23lod4_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#ID=pac30e21_optv2s13off_sin23lo_101bin_wreactorthrow_StatOnly_merger_${IDN}
#OD=pac30e21_optv2s13off_sin23lo_101bin_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#ID=pac30e21_optv2s13off_sin23lo_christprior_wreactorthrow_StatOnly_merger_${IDN}
#OD=pac30e21_optv2s13off_sin23lo_christprior_wreactorthrow_StatOnly_sensiAsimov_${ODN}
...
-b ${inum} \
-ft ${DIR}/inputs/Throws/Osc_2015_Reac_dm32narrow_opt30v2s13offhi_nolooct.root \
-n ${ODN} \
