...
#ID=current_narrow4_wreactorthrow_StatOnly_merger_${ODN}
#OD=current_narrow4_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#ID=current_narrow2x_wreactorthrow_StatOnly_merger_${IDN}
#OD=current_narrow2x_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#ID=current_opt_wreactorthrow_StatOnly_merger_${IDN}
#OD=current_opt_wreactorthrow_StatOnly_sensiAsimov_${ODN}
...
OD=current_s13off_sin23hi528_wreactorthrow_StatOnly_sensiAsimov_${ODN}

#ID=current_narrow2x_wreactorthrow_StatOnly_merger_${IDN}
#OD=current_narrow2x_sin23lo_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=current_narrow2x_sin23hi_wreactorthrow_StatOnly_sensiAsimov_${ODN}
...
-e ${DIR}/outputs/asimovhi528/AsimovPoint01_PAC_current_Xp_StatOnly.root \
-b ${inum} \
