...
ID=current_s13off_wreactorthrow_inverted_StatOnly_merger_${ODN}
#OD=current_s13off_inv_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=current_s13off_sin23hi_inv_wreactorthrow_StatOnly_sensiAsimov_${ODN}
OD=current_s13off_sin23hi528_inv_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=current_s13off_sin23lo_inv_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=current_s13off_sin23lo04_inv_wreactorthrow_StatOnly_sensiAsimov_${ODN}
...
-a ${DIR}/outputs/Template_files/statonly/Templates_current_StatOnly.root \
