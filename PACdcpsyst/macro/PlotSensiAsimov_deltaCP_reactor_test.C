...
//Main Macro
void PlotSensiAsimov_deltaCP_reactor_test(TString SensiAsimovFile, TString filename){
  ...
  Sensi->Add("/home/t2k/cvson/ptheta/pac2016/20151128/Ptheta_MultiSample/PACdcpsyst/outputs/SensiAsimov/"+SensiAsimovFile);
  ...
  for(int i=0; i<Sensi->GetEntries(); i++){
    Sensi->GetEntry(i);
    if(!TMath::Finite(AvNLLtot)) continue;
