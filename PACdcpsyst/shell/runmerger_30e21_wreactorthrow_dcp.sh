...
#OD=pac30e21_100k4check_optv2s13off_fakesyst_wreactorthrow_merger_${ODN}
#OD=pac30e21_100k4check_optv2s13off_fakesyst_sin23hi_wreactorthrow_merger_${ODN}
OD=pac30e21_100k4check_optv2s13off_fakesyst_sin23lo_wreactorthrow_merger_${ODN}
