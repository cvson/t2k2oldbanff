...
#OD=pac30e21_opt_wreactorthrow_StatOnly_merger_${ODN}
...
#OD=pac30e21_optv2s13off_sin23lo_wreactorthrow_StatOnly_merger_${ODN}
...
./Merger \
-t ${DIR}/outputs/Template_files/Templates_pac30e21_StatOnly.root \
