...
#OD=pac30e21_100k4check_optv2s13off_dcp22_wreactorthrow_sensiAsimov_${ODN}
#ID=pac30e21_100k4check_optv2s13off_fakesyst_sin23hi_wreactorthrow_merger_${IDN}
#OD=pac30e21_100k4check_optv2s13off_sin23hi_dcp22_wreactorthrow_sensiAsimov_${ODN}
ID=pac30e21_100k4check_optv2s13off_fakesyst_sin23lo_wreactorthrow_merger_${IDN}
OD=pac30e21_100k4check_optv2s13off_sin23lo_dcp22_wreactorthrow_sensiAsimov_${ODN}
