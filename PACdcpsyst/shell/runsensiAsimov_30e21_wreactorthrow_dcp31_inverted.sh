...
#OD=pac30e21_100k4check_optv2s13off_dcp31_inv_wreactorthrow_sensiAsimov_${ODN}
#ID=pac30e21_100k4check_optv2s13off_fakesyst_sin23hi_inv_wreactorthrow_merger_${IDN}
#OD=pac30e21_100k4check_optv2s13off_sin23hi_dcp31_inv_wreactorthrow_sensiAsimov_${ODN}
ID=pac30e21_100k4check_optv2s13off_fakesyst_sin23lo_inv_wreactorthrow_merger_${IDN}
OD=pac30e21_100k4check_optv2s13off_sin23lo_dcp31_inv_wreactorthrow_sensiAsimov_${ODN}
...
-e ${DIR}/outputs/dcptruelo/AsimovPoint01_PAC_30e21_Xp_StatOnly_dcp31.root \
-b ${inum} \
