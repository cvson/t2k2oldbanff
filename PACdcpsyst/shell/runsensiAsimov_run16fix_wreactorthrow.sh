...
ID=run16_fix_wreactorthrow_merger_${ODN}
OD=run16_fix_wreactorthrow_sensiAsimov_${ODN}
...
-a ${DIR}/outputs/Template_files/Templates_Run1-6POT_fix.root \
-f ${DIR}/outputs/MergedFiles/${ID} \
-e ${DIR}/outputs/AsimovPoint01_Run1-6_Xp_fix.root \
-b ${inum} \
