...
//Main Macro
void PlotSepFitter_appearance_reactor_test(TString SepFitterFile, TString filename){
  ...
  TH2D *DF_t13_dcp = new TH2D("DF_t13_dcp", "Data Fit", 81, 0.0595, 0.1405, 51, -3.2028, 3.2028);

  TH2D *DF_norm[4];
  DF_norm[0] = new TH2D("DF_t13_dcp_norm_nue", "Data Fit", 81, 0.0595, 0.1405, 51, -3.2028, 3.2028);
  DF_norm[1] = new TH2D("DF_t13_dcp_norm_numu", "Data Fit", 81, 0.0595, 0.1405, 51, -3.2028, 3.2028);
  DF_norm[2] = new TH2D("DF_t13_dcp_norm_nuebar", "Data Fit", 81, 0.0595, 0.1405, 51, -3.2028, 3.2028);
  DF_norm[3] = new TH2D("DF_t13_dcp_norm_numubar", "Data Fit", 81, 0.0595, 0.1405, 51, -3.2028, 3.2028);

  TH2D *DF_like[4];
  DF_like[0] = new TH2D("DF_t13_dcp_Like_nue", "Data Fit", 81, 0.0595, 0.1405, 51, -3.2028, 3.2028);
  DF_like[1] = new TH2D("DF_t13_dcp_Like_numu", "Data Fit", 81, 0.0595, 0.1405, 51, -3.2028, 3.2028);
  DF_like[2] = new TH2D("DF_t13_dcp_Like_nuebar", "Data Fit", 81, 0.0595, 0.1405, 51, -3.2028, 3.2028);
  DF_like[3] = new TH2D("DF_t13_dcp_Like_numubar", "Data Fit", 81, 0.0595, 0.1405, 51, -3.2028, 3.2028);
