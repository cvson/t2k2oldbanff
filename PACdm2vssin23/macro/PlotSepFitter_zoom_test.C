...
//Main Macro
void PlotSepFitter_zoom_test(TString SepFitterFile, TString filename){
  ...
  TH2D *SA_t23_dM32 = new TH2D("SA_t23_dM32", "Data Fit", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);

  TH2D *SA_norm[4];
  SA_norm[0] = new TH2D("SA_t23_dM32_norm_nue", "Data Fit", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
  SA_norm[1] = new TH2D("SA_t23_dM32_norm_numu", "Data Fit", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
  SA_norm[2] = new TH2D("SA_t23_dM32_norm_nuebar", "Data Fit", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
  SA_norm[3] = new TH2D("SA_t23_dM32_norm_numubar", "Data Fit", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);

  TH2D *SA_like[4];
  SA_like[0] = new TH2D("SA_t23_dM32_Like_nue", "Data Fit", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
  SA_like[1] = new TH2D("SA_t23_dM32_Like_numu", "Data Fit", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
  SA_like[2] = new TH2D("SA_t23_dM32_Like_nuebar", "Data Fit", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
  SA_like[3] = new TH2D("SA_t23_dM32_Like_numubar", "Data Fit", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
  ...
  for(int i=0; i<SepFit->GetEntries(); i++){
    ...
    SA_t23_dM32->SetBinContent((i%51)+1, TMath::FloorNint(i/51)+1, NLLtot - globalmin);
    for(int k=0; k<4; k++){
      //single sample shape only for Sensitivity, Poisson likelihood for Asimov
      SA_like[k]->SetBinContent((i%51)+1, TMath::FloorNint(i/51)+1, NLL_like[k] - like_min[k]);
      //single sample norm only
      SA_norm[k]->SetBinContent((i%51)+1, TMath::FloorNint(i/51)+1, NLL_norm[k] - norm_min[k]);
    }
  ...
  //  best_all->Draw("Psame");
  PrintHisto(c1, "SepFitter_test_all", filename);
