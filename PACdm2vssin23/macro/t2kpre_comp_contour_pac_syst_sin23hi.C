{
    ...
    TString subname = "current_t23dm32_point1_sin23hi_wreactorthrow_StatOnly";
    TFile *pfile1 = new TFile("../plots/"+subname+".root");
    
    TString subnamesys = "current_setB_t23dm32_point1_sin23hi_wreactorthrow";
    TFile *pfile1sys = new TFile("../plots/"+subnamesys+".root");
    
    TString subname2 = "pac7d8e21_t23dm32_point1_sin23hi_wreactorthrow_StatOnly";
    TFile *pfile2 = new TFile("../plots/"+subname2+".root");
    TString subname2sys = "pac7d8e21_setB_t23dm32_point1_sin23hi_wreactorthrow";
    TFile *pfile2sys = new TFile("../plots/"+subname2sys+".root");
    
    TString subname3 = "pac30e21_t23dm32_point1_sin23hi_wreactorthrow_StatOnly";
    TFile *pfile3 = new TFile("../plots/"+subname3+".root");
    TString subname3sys = "pac30e21_setB_t23dm32_point1_sin23hi_wreactorthrow";
    TFile *pfile3sys = new TFile("../plots/"+subname3sys+".root");
    
    TString plotsubname = "t2kpre_t23dm32_point1_sin23hi_wreactorthrow";
   ...
   gStyle->SetLineWidth(2);
    ...
    leg0->AddEntry(pcont1_cl90, "Current POT , 90% C.L", "l");
