...
ID=run14_merger_StatOnly_fix_${ODN}
OD=run14_sensiAsimov_StatOnly_fix_${ODN}
...
-a ${DIR}/outputs/Template_files/Templates_Run1-4POT_fix_StatOnly.root \
-f ${DIR}/outputs/MergedFiles/${ID} \
-e ${DIR}/outputs/AsimovPoint01_Run1-4_Xp_StatOnly.root \
-b ${inum} \
