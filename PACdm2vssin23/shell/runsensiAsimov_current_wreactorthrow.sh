...
ID=current_setB_wreactorthrow_merger_${ODN}
#OD=current_setB_wreactorthrow_sensiAsimov_${ODN}
#OD=current_setB_sin23hi_wreactorthrow_sensiAsimov_${ODN}
OD=current_setB_sin23lo_wreactorthrow_sensiAsimov_${ODN}
...
-e ${DIR}/outputs/asimovlo/AsimovPoint01_PAC_current_Xp_StatOnly.root \
-b ${inum} \
