...
ID=current_wreactorthrow_StatOnly_merger_${ODN}
#OD=current_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=current_sin23hi_wreactorthrow_StatOnly_sensiAsimov_${ODN}
OD=current_sin23lo_wreactorthrow_StatOnly_sensiAsimov_${ODN}
