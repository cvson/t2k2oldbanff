...
cd /home/t2k/cvson/gpfs/ptheta/pac2016/20151128/Ptheta_MultiSample/PACdm2vssin23/bin
DIR=/home/t2k/cvson/gpfs/ptheta/pac2016/20151128/Ptheta_MultiSample/PACdm2vssin23
DIRBASE=/home/t2k/cvson/gpfs/ptheta/pac2016/Ptheta_MultiSample/frJame
#ID=pac30e21_wreactorthrow_merger_${ODN}
#OD=pac30e21_wreactorthrow_sensiAsimov_${ODN}
#ID=pac30e21_setB_wreactorthrow_merger_${ODN}
#OD=pac30e21_setB_wreactorthrow_sensiAsimov_${ODN}
#ID=pac30e21_setB_sin23hi_wreactorthrow_merger_${ODN}
#OD=pac30e21_setB_sin23hi_wreactorthrow_sensiAsimov_${ODN}
ID=pac30e21_setB_sin23lo_wreactorthrow_merger_${ODN}
OD=pac30e21_setB_sin23lo_wreactorthrow_sensiAsimov_${ODN}
