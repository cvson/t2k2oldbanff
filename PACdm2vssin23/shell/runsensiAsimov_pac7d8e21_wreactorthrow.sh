...
#ID=pac7d8e21_wreactorthrow_merger_${ODN}
#OD=pac7d8e21_wreactorthrow_sensiAsimov_${ODN}
#ID=pac7d8e21_setB_wreactorthrow_merger_${ODN}
#OD=pac7d8e21_setB_wreactorthrow_sensiAsimov_${ODN}
#ID=pac7d8e21_setB_sin23hi_wreactorthrow_merger_${ODN}
#OD=pac7d8e21_setB_sin23hi_wreactorthrow_sensiAsimov_${ODN}
ID=pac7d8e21_setB_sin23lo_wreactorthrow_merger_${ODN}
OD=pac7d8e21_setB_sin23lo_wreactorthrow_sensiAsimov_${ODN}
