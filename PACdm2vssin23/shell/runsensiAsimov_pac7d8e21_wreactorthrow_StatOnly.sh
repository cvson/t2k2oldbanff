...
#ID=pac7d8e21_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac7d8e21_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#ID=pac7d8e21_sin23hi_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac7d8e21_sin23hi_wreactorthrow_StatOnly_sensiAsimov_${ODN}
ID=pac7d8e21_sin23lo_wreactorthrow_StatOnly_merger_${ODN}
