   {
    ...
    for (Int_t isam=0; isam<NSAMPLE; ++isam) {
        if(isam==0){pfile[isam] = new TFile(Form("../plots/%s_s13off_sin23hi_wreactorthrow_StatOnly_sensiAsimov_100k_dm32.root",m_name[isam]));
        pfilesyst[isam] = new TFile(Form("../plots/%s_s13off_sin23hi_wreactorthrow_sensiAsimov_100k_dm32.root",m_name[isam]));
        }
        else {
        pfile[isam] = new TFile(Form("../plots/%s_optv2s13off_sin23hi_wreactorthrow_StatOnly_sensiAsimov_100k_dm32.root",m_name[isam]));
        pfilesyst[isam] = new TFile(Form("../plots/%s_optv2s13off_sin23hi_wreactorthrow_sensiAsimov_100k_dm32.root",m_name[isam]));
        }
    ...
    TString subname = "t2kpre_dm32_point1_wreactorthrow_all_100k_optv2s13off_sin23hi_bless";
