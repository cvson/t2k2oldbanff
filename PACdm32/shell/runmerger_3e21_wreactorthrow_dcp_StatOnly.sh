...
#OD=pac3e21_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac3e21_optv2s13off_wreactorthrow_StatOnly_merger_${ODN}
#OD=pac3e21_optv2s13off_sin23hi_wreactorthrow_StatOnly_merger_${ODN}
OD=pac3e21_optv2s13off_sin23lo_wreactorthrow_StatOnly_merger_${ODN}
...
./Merger \
-t ${DIR}/outputs/Template_files/Templates_pac3e21_StatOnly.root \
