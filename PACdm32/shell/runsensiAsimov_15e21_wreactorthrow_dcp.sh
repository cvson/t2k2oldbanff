...
#ID=pac15e21_wreactorthrow_merger_${ODN}
#OD=pac15e21_wreactorthrow_sensiAsimov_${ODN}
#ID=pac15e21_optv2s13off_wreactorthrow_merger_${ODN}
#OD=pac15e21_optv2s13off_wreactorthrow_sensiAsimov_${ODN}
#ID=pac15e21_optv2s13off_sin23hi_wreactorthrow_merger_${ODN}
#OD=pac15e21_optv2s13off_sin23hi_wreactorthrow_sensiAsimov_${ODN}
ID=pac15e21_optv2s13off_sin23lo_wreactorthrow_merger_${ODN}
OD=pac15e21_optv2s13off_sin23lo_wreactorthrow_sensiAsimov_${ODN}
