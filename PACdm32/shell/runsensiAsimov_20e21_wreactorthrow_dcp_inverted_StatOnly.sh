...
ID=pac20e21_wreactorthrow_inverted_StatOnly_merger_${ODN}
OD=pac20e21_wreactorthrow_inverted_StatOnly_sensiAsimov_${ODN}
...
-e ${DIR}/outputs/AsimovPoint01_PAC_20e21_Xp_StatOnly.root \
-b ${inum} \
