...
#ID=pac30e21_setC_wreactorthrow_merger_${ODN}
#OD=pac30e21_setC_wreactorthrow_sensiAsimov_${ODN}
#ID=pac30e21_setB_wreactorthrow_merger_${ODN}
#OD=pac30e21_setB_wreactorthrow_sensiAsimov_${ODN}
#ID=pac30e21_optv2s13off_wreactorthrow_merger_${ODN}
#OD=pac30e21_optv2s13off_wreactorthrow_sensiAsimov_${ODN}
ID=pac30e21_optv2s13off_sin23lo_wreactorthrow_merger_${ODN}
OD=pac30e21_optv2s13off_sin23lo_wreactorthrow_sensiAsimov_${ODN}
