...
#ID=current_wreactorthrow_merger_${ODN}
#OD=current_wreactorthrow_sensiAsimov_${ODN}
ID=current_s13off_wreactorthrow_merger_${ODN}
#OD=current_s13off_wreactorthrow_sensiAsimov_${ODN}
#OD=current_s13off_sin23hi_wreactorthrow_sensiAsimov_${ODN}
OD=current_s13off_sin23lo_wreactorthrow_sensiAsimov_${ODN}
