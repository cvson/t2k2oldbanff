...
//Main Macro
void PlotSensiAsimov_appearance_test(TString SensiAsimovFile, TString filename){
  ...
  TH2D *SA_t13_dcp = new TH2D("SA_t13_dcp", "Asimov Sensitivity", 81, -0.005, 0.805, 51, -3.2028, 3.2028);

  TH2D *SA_norm[4];
  SA_norm[0] = new TH2D("SA_t13_dcp_norm_nue", "Asimov Sensitivity", 81, -0.005, 0.805, 51, -3.2028, 3.2028);
  SA_norm[1] = new TH2D("SA_t13_dcp_norm_numu", "Asimov Sensitivity", 81, -0.005, 0.805, 51, -3.2028, 3.2028);
  SA_norm[2] = new TH2D("SA_t13_dcp_norm_nuebar", "Asimov Sensitivity", 81, -0.005, 0.805, 51, -3.2028, 3.2028);
  SA_norm[3] = new TH2D("SA_t13_dcp_norm_numubar", "Asimov Sensitivity", 81, -0.005, 0.805, 51, -3.2028, 3.2028);

  TH2D *SA_like[4];
  SA_like[0] = new TH2D("SA_t13_dcp_Like_nue", "Asimov Sensitivity", 81, -0.005, 0.805, 51, -3.2028, 3.2028);
  SA_like[1] = new TH2D("SA_t13_dcp_Like_numu", "Asimov Sensitivity", 81, -0.005, 0.805, 51, -3.2028, 3.2028);
  SA_like[2] = new TH2D("SA_t13_dcp_Like_nuebar", "Asimov Sensitivity", 81, -0.005, 0.805, 51, -3.2028, 3.2028);
  SA_like[3] = new TH2D("SA_t13_dcp_Like_numubar", "Asimov Sensitivity", 81, -0.005, 0.805, 51, -3.2028, 3.2028);
