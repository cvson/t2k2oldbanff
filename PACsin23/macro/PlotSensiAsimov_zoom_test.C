...
//Main Macro
void PlotSensiAsimov_zoom_test(TString SensiAsimovFile, TString filename){
    ...
    Sensi->Add("/home/t2k/cvson/ptheta/pac2016/Ptheta_MultiSample/frJame/NumudisPAC/outputs/SensiAsimov/"+SensiAsimovFile);
    ...
    TH2D *SA_t23_dM32 = new TH2D("SA_t23_dM32", "Asimov Sensitivity", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
    
    TH2D *SA_norm[4];
    SA_norm[0] = new TH2D("SA_t23_dM32_norm_nue", "Asimov Sensitivity", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
    SA_norm[1] = new TH2D("SA_t23_dM32_norm_numu", "Asimov Sensitivity", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
    SA_norm[2] = new TH2D("SA_t23_dM32_norm_nuebar", "Asimov Sensitivity", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
    SA_norm[3] = new TH2D("SA_t23_dM32_norm_numubar", "Asimov Sensitivity", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
    
    TH2D *SA_like[4];
    SA_like[0] = new TH2D("SA_t23_dM32_Like_nue", "Asimov Sensitivity", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
    SA_like[1] = new TH2D("SA_t23_dM32_Like_numu", "Asimov Sensitivity", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
    SA_like[2] = new TH2D("SA_t23_dM32_Like_nuebar", "Asimov Sensitivity", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
    SA_like[3] = new TH2D("SA_t23_dM32_Like_numubar", "Asimov Sensitivity", 51, 0.296, 0.704, 101, -0.125e-3, 5.125e-3);
