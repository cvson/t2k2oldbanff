   {
    ...
    for (Int_t isam=0; isam<NSAMPLE; ++isam) {
        ...
        pfile[isam] = new TFile(Form("../plots/%s_optv2s13off_wreactorthrow_StatOnly_sensiAsimov_100k_sin23.root",m_name[isam]));
    ...
    TString subname = "t2kpre_sin23_point1_wreactorthrow_all_100k_optv2s13off_maxi_bless";
