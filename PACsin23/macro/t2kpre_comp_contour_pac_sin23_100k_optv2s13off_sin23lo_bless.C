   {
    ...
    //const char *m_name_long[NSAMPLE] = {"current","7.8e21","30e21"};
    ...
    for (Int_t isam=0; isam<NSAMPLE; ++isam) {
        if(isam==0){pfile[isam] = new TFile(Form("../plots/%s_s13off_sin23lo_wreactorthrow_StatOnly_sensiAsimov_100k_sin23.root",m_name[isam]));
        pfilesyst[isam] = new TFile(Form("../plots/%s_s13off_sin23lo_wreactorthrow_sensiAsimov_100k_sin23.root",m_name[isam]));
        }
        else {
        pfile[isam] = new TFile(Form("../plots/%s_optv2s13off_sin23lo_wreactorthrow_StatOnly_sensiAsimov_100k_sin23.root",m_name[isam]));
        pfilesyst[isam] = new TFile(Form("../plots/%s_optv2s13off_sin23lo_wreactorthrow_sensiAsimov_100k_sin23.root",m_name[isam]));
        }
        ...
        pchain->Add(Form("../plots/%s_wreactorthrow_StatOnly_sensiAsimov_100k_sin23.root",m_name[isam]));
        pchainsys->Add(Form("../plots/%s_wreactorthrow_sensiAsimov_100k_sin23.root",m_name[isam]));
    }
 
    //TString subname = "pac_dcp_point1_wreactorthrow";
    TString subname = "t2kpre_sin23_point1_wreactorthrow_all_100k_optv2s13off_sin23lo_bless";
    ...
    hisdcpsyst[2]->GetXaxis()->SetTitle("sin^{2}#theta_{23}");
    //hisdcp[2]->SetMinimum(0);
    //hisdcp[4]->GetXaxis()->SetRangeUser(0.44,0.58);
    hisdcpsyst[2]->GetXaxis()->SetRangeUser(0.3,0.7);
   ...
   //hisdcpsyst[2]->SetMaximum(50);
    ...
    //TLegend* leg1 = new TLegend(.6, .7, 0.75, .85);
    ...
    text2kpre->Draw();
    hisdcpsyst[2]->GetYaxis()->SetRangeUser(0,100);
    gPad->Modified();
