...
#OD=pac2d5e21c5_sin23lo04_wreactorthrow_StatOnly_sensiAsimov_${ODN}
...
#OD=pac2d5e21c5_sin23hi_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=pac2d5e21c5_sin23lo_wreactorthrow_StatOnly_sensiAsimov_${ODN}
#OD=pac2d5e21c5_sin23lod4_wreactorthrow_StatOnly_sensiAsimov_${ODN}
...
-e ${DIR}/outputs/asimovhi/AsimovPoint01_PAC_2d5e21c5_Xp_StatOnly.root \
-b ${inum} \
