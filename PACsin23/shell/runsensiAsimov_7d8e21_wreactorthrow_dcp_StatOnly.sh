...
#OD=pac7d8e21_sin23lod4_wreactorthrow_StatOnly_sensiAsimov_${ODN}
...
#ID=pac7d8e21_optv2s13off_sin23hi_wreactorthrow_StatOnly_merger_${IDN}
#OD=pac7d8e21_optv2s13off_sin23hi_wreactorthrow_StatOnly_sensiAsimov_${ODN}
...
-e ${DIR}/outputs/asimovhi57/AsimovPoint01_PAC_7d8e21_Xp_StatOnly.root \
-b ${inum} \
