...
#ID=pac7d8e21c4_optv2s13off_sin23hi_wreactorthrow_StatOnly_merger_${IDN}
#OD=pac7d8e21c4_optv2s13off_sin23hi_wreactorthrow_StatOnly_sensiAsimov_${ODN}
...
-e ${DIR}/outputs/asimovhi/AsimovPoint01_PAC_7d8e21c4_Xp_StatOnly.root \
-b ${inum} \
